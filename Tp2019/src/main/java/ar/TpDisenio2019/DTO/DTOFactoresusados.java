...
/**
 * DTOFactoresusados generated by hbm2java
 */
public class DTOFactoresusados{
	...
	public DTOFactoresusados(int idFacUsados) {
		this.idFacUsados = idFacUsados;
	}

	public DTOFactoresusados(int idFacUsados, Integer idMedPorc, Float porcentajeCobertura,
