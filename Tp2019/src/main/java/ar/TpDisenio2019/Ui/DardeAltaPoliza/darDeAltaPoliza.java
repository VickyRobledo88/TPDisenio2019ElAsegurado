...
public class darDeAltaPoliza extends JFrame {
	...
	//private int ingresoABuscarCliente=0;
	List<DTOProvincia>  dtoListaProvincia = new ArrayList<DTOProvincia>();
	...
	public darDeAltaPoliza() {
		...
		//		ingresoABuscarCliente=1; /*Al ingresar a buscar Cliente Setea en 1 para poder ingresar los Datos de Póliza*/
		...
		*/
		...
		btnCompletarHijos.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String nro = textField_CantHijos.getText();
