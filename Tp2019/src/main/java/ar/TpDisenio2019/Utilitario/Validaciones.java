...
public class Validaciones {
		...
		public boolean validarNúmeroDeDocumento(String númeroDeDocumento, String tipoDeDocumento)
		{
		...
		public boolean validarCampoNuméricoEstático(String valorDelCampo, int valorMáximoPermitido)
		{
